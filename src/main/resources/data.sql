...
INSERT INTO ALTERNATIVE (IDALT, ANAME) VALUES (1, 'HP 2017 15.6');
INSERT INTO ALTERNATIVE (IDALT, ANAME) VALUES (2, 'Dell Latitude');
INSERT INTO ALTERNATIVE (IDALT, ANAME) VALUES (3, 'Apple MacBook');
...
VALUES (1, 'Диагональ экрана', 10, 10, 'Количественный', 'Max', 'Дюймы', 'Абсолютная');
insert into CRITERION (IDCRIT,CNAME, CRANGE, CWEIGHT, CTYPE, OPTIMTYPE, EDIZMER, SCALETYPE)
VALUES (2, 'Вес', 5, 5, 'Количественный', 'Min', 'Килограммы', 'Абсолютная');
insert into CRITERION (IDCRIT,CNAME, CRANGE, CWEIGHT, CTYPE, OPTIMTYPE, EDIZMER, SCALETYPE)
VALUES (3, 'Батарея', 10, 10, 'Количественный', 'Max', 'Часы', 'Абсолютная');
insert into CRITERION (IDCRIT,CNAME, CRANGE, CWEIGHT, CTYPE, OPTIMTYPE, EDIZMER, SCALETYPE)
VALUES (4, 'Производитель', 2, 2, 'Качественный', 'Max', 'Неприменимо', 'Номинальная');
insert into CRITERION (IDCRIT,CNAME, CRANGE, CWEIGHT, CTYPE, OPTIMTYPE, EDIZMER, SCALETYPE)
VALUES (5, 'Процессор', 5, 5, 'Качественный', 'Max', 'Неприменимо', 'Порядковая');
